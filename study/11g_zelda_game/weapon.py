...
class Weapon(pygame.sprite.Sprite):
    def __init__(self, player, groups):
        ...
        # placement
        if direction == 'right':
            self.rect = self.image.get_rect(midleft = player.rect.midright +  pygame.math.Vector2(-12,16))
        elif direction == 'left':
            self.rect = self.image.get_rect(midright = player.rect.midleft + pygame.math.Vector2(12,16))
        elif direction == 'up':
